...
export const EditorLayout = ({
  ...
  const toggleFocusMode = () => {
    ...
    if (!isFocusMode) {
      // Entering focus mode - hide LLM panel
      setIsLLMPanelCollapsed(true);
    } else {
      // Exiting focus mode - restore LLM panel
  ...
  return (
    <div className="flex-1 flex gap-3 lg:gap-4 h-full overflow-hidden p-3 lg:p-4">
      {/* Editor area - now takes up more space without the outline sidebar */}
      ...
      {/* Desktop action buttons including outline popup */}
